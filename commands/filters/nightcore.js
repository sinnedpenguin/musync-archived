...
module.exports = {
  ...
  async execute(interaction) {
    ...
    filterManager.toggleFilter('nightcore');
    ...
    const filterEmbed = new EmbedBuilder()
      .setColor(config.embedColor)
      .setDescription(`:white_check_mark: | \`Nightcore\` filter is now ${player.filters.nightcore ? '`enabled`' : '`disabled`'}! Use ${config.commands.nowplaying} to see all enabled filters.`)
      .setTimestamp();
