...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const filterEmbed = new EmbedBuilder()
      .setColor(config.embedColor)
      .setDescription(`:white_check_mark: | \`Vibrato\` filter is now ${player.filters.vibrato ? '`enabled`' : '`disabled`'}! Use </nowplaying:1190439304183414877> to see all enabled filters.`)
      .setTimestamp();
